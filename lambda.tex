...
%TCIDATA{LastRevised=Tuesday, April 26, 2016 21:10:01}
...
\begin{proof}
[Proof of Theorem 3.3.]\textbf{(a)} Define a map $\overline{\lambda}%
_{T}:K\left[  S\right]  \rightarrow\left(  K\left[  S\right]  \right)  \left[
\left[  T\right]  \right]  $ by $\overline{\lambda}_{T}\left(  u\right)
=\sum\limits_{i\in\mathbb{N}}\overline{\lambda}^{i}\left(  u\right)  T^{i}$
for every $u\in K\left[  S\right]  $. Then, according to the definition of the
maps $\overline{\lambda}^{i}$, we have $\overline{\lambda}_{T}\left(
