...
%TCIDATA{LastRevised=Tuesday, October 04, 2011 21:18:32}
...
%\\[8mm]
%Version 0.0.5 (last revised 15 June 2011)
%\end{center}
%\end{titlepage}
%\newpage
%$\ \ \ $
...
Let $K\left[  T\right]  ^{+}$ be the subset of $K\left[  T\right]  $ defined
by%
\begin{align*}
...
T\right]  \right]  ^{+}.$ The elements of $1+K\left[  T\right]  ^{+}$ are
polynomials. We have:
...
every power series $\varphi\in1+\mathbb{Z}\left[  \left[  t\right]  \right]
^{+}$ with constant term equal to $1$, a polynomial $\operatorname*{Td}%
_{\varphi,j}\in\mathbb{Z}\left[  \alpha_{1},\alpha_{2},...,\alpha_{j}\right]
$ for every $j\in\mathbb{N}$ such that
\[
...
\begin{quote}
\textbf{Definition.} Let $\varphi\in1+\mathbb{Z}\left[  \left[  t\right]
\right]  ^{+}$ be a power series with constant term equal to $1$. Our goal is
to define a polynomial $\operatorname*{Td}_{\varphi,j}\in\mathbb{Z}\left[
...
\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]  $ (this is the coefficient of
the power series $\prod\limits_{i=1}^{m}\varphi\left(  U_{i}T\right)
\in\left(  \mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]  \right)  \left[
...
$\operatorname*{Todd}\nolimits_{\left(  \varphi,j\right)  }\in\mathbb{Z}%
...
$\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]  $, where the grading is given
...
,j\right)  }$ under the canonical homomorphism $\mathbb{Z}\left[  \alpha
_{1},\alpha_{2},...,\alpha_{m}\right]  \rightarrow\mathbb{Z}\left[  \alpha
...
\nolimits_{\varphi,j}\in\mathbb{Z}\left[  \alpha_{1},\alpha_{2},...,\alpha
...
\begin{quote}
\textbf{Lemma 10.2.} Let $\varphi\in1+\mathbb{Z}\left[  \left[  t\right]
\right]  ^{+}$ be a power series with constant term equal to $1$. Let
$m\in\mathbb{N}$ and $n\in\mathbb{N}$ be such that $m\geq n$. Then, in the
polynomial ring $\mathbb{Z}\left[  U_{1},U_{2},...,U_{n}\right]  $, we have
$\operatorname*{Todd}\nolimits_{\left(  \varphi,j\right)  ,j,\left[  m\right]
}\left(  X_{1},X_{2},...,X_{j}\right)  =\operatorname*{Todd}\nolimits_{\left(
\varphi,j\right)  ,j,\left[  n\right]  }\left(  X_{1},X_{2},...,X_{j}\right)
$.
\end{quote}
...
Let $\operatorname*{proj}\nolimits_{m,n}$ be the canonical ring epimorphism
$\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]  \rightarrow\mathbb{Z}\left[
U_{1},U_{2},...,U_{n}\right]  $ which maps every $U_{i}$ to $\left\{
\begin{array}
[c]{c}%
U_{i},\text{ if }i\leq n;\\
0,\text{ if }i>n
\end{array}
\right.  $. This ring homomorphism $\operatorname*{proj}\nolimits_{m,n}$
induces a ring homomorphism $\operatorname*{proj}\nolimits_{m,n}\left[
\left[  T\right]  \right]  :\left(  \mathbb{Z}\left[  U_{1},U_{2}%
,...,U_{m}\right]  \right)  \left[  \left[  T\right]  \right]  \rightarrow
\left(  \mathbb{Z}\left[  U_{1},U_{2},...,U_{n}\right]  \right)  \left[
\left[  T\right]  \right]  $ which maps every power series $\sum
\limits_{i\in\mathbb{N}}a_{i}T^{i}$ (with $a_{i}\in\mathbb{Z}\left[
U_{1},U_{2},...,U_{m}\right]  $ for every $i\in\mathbb{N}$) to $\sum
\limits_{i\in\mathbb{N}}\operatorname*{proj}\nolimits_{m,n}\left(
a_{i}\right)  T^{i}$. For every $i\in\left\{  1,2,...,m\right\}  $, this
homomorphism $\operatorname*{proj}\nolimits_{m,n}\left[  \left[  T\right]
\right]  $ maps satisfies $\left(  \operatorname*{proj}\nolimits_{m,n}\left[
\left[  T\right]  \right]  \right)  \left(  \varphi\left(  U_{i}T\right)
\right)  =\left\{
\begin{array}
[c]{c}%
...
\in\mathbb{Z}\left[  \left[  t\right]  \right]  $ in the form $\varphi
=\sum\limits_{k\in\mathbb{N}}\varphi_{k}t^{k}$ with $\varphi_{k}\in\mathbb{Z}$
...
\nolimits_{m,n}\text{ is a ring}\\\text{homomorphism)}}}T^{k}%
\ \ \ \ \ \ \ \ \ \ \left(  \text{by the definition of }\operatorname*{proj}%
...
T\right]  \right]  $ is a ring homomorphism, we have%
\begin{align*}
...
\left(\mathbb Z\left[U_1,U_2,...,U_m\right]\right)\left[\left[T\right]\right] \ar[r]^{\operatorname*{proj}_{m,n}\left[\left[T\right]\right]} \ar[d]_{\operatorname*{Coeff}_j} & \left(\mathbb Z\left[U_1,U_2,...,U_m\right]\right)\left[\left[T\right]\right]  \ar[d]_{\operatorname*{Coeff}_n} \\
\mathbb Z\left[U_1,U_2,...,U_m\right] \ar[r]^{\operatorname*{proj}_{m,n}} & \mathbb Z\left[U_1,U_2,...,U_n\right]
}
\]
...
,j,\left[  m\right]  }\text{ is a polynomial over }\mathbb{Z}\text{ and
}\operatorname*{proj}\nolimits_{m,n}\text{ is a ring homomorphism,}\\
\text{and since polynomials over }\mathbb{Z}\text{ commute with ring
homomorphisms}%
\end{array}
\right) \\
&  =\operatorname*{Todd}\nolimits_{\left(  \varphi,j\right)  ,j,\left[
...
\begin{array}
[c]{c}%
\text{since }\operatorname*{proj}\nolimits_{m,n}\text{ is the ring
homomorphism which maps every }U_{i}\text{ to }\left\{
\begin{array}
[c]{c}%
U_{i},\text{ if }i\leq n;\\
0,\text{ if }i>n
...
\]
in the polynomial ring $\mathbb{Z}\left[  U_{1},U_{2},...,U_{n}\right]  $.
...
$ in the polynomial ring $\mathbb{Z}\left[  U_{1},U_{2},...,U_{j}\right]  $.
Since the elements $X_{1},$ $X_{2},$ $...,$ $X_{j}$ of $\mathbb{Z}\left[
...
$\operatorname*{Td}\nolimits_{\varphi,j}\left(  X_{1},X_{2},...,X_{j}\right)
=\operatorname*{Todd}\nolimits_{\left(  \varphi,j\right)  ,j,\left[  m\right]
}\left(  X_{1},X_{2},...,X_{j}\right)  $ in the ring $\mathbb{Z}\left[
U_{1},U_{2},...,U_{m}\right]  $.
...
=\operatorname*{Todd}\nolimits_{\left(  \varphi,j\right)  ,j,\left[  m\right]
}\left(  X_{1},X_{2},...,X_{j}\right)  $ in the polynomial ring $\mathbb{Z}%
...
satisfied in the ring $\left(  \mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]
\right)  \left[  \left[  T\right]  \right]  $.

\textit{Proof.} Every power series $P\in\left(  \mathbb{Z}\left[  U_{1}%
...
\begin{quote}
\textbf{Definition.} Let $\left(  K,\left(  \lambda^{i}\right)  _{i\in
\mathbb{N}}\right)  $ be a $\lambda$-ring. Let $\varphi\in1+\mathbb{Z}\left[
\left[  t\right]  \right]  ^{+}$ be a power series with constant term equal to
$1$. We define a map $\operatorname*{td}_{\varphi,T}:K\rightarrow K\left[
...
\begin{quote}
\textbf{Proposition 10.3.} Let $\left(  K,\left(  \lambda^{i}\right)
_{i\in\mathbb{N}}\right)  $ be a $\lambda$-ring. Let $u\in\mathbb{Z}$. For
every $x\in K$, we have $\operatorname*{td}\nolimits_{1+ut,T}\left(  x\right)
=\lambda_{uT}\left(  x\right)  $, where $\lambda_{uT}\left(  x\right)  $ means
...
\begin{quote}
\textbf{Proposition 10.4.} Let $u\in\mathbb{Z}$. Then, $\operatorname*{Td}%
\nolimits_{1+ut,j}=u^{j}\alpha_{j}$ (in the polynomial ring $\mathbb{Z}\left[
\alpha_{1},\alpha_{2},...,\alpha_{j}\right]  $) for every $j\in\mathbb{N}$.
\end{quote}

\textit{Proof of Proposition 10.4.} Let $m\in\mathbb{N}$. Consider the ring
$\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]  $ (the polynomial ring in $m$
indeterminates $U_{1},$ $U_{2},$ $...,$ $U_{m}$ over the ring $\mathbb{Z}$).
For every $i\in\mathbb{N}$, let $X_{i}=\sum\limits_{\substack{S\subseteq
\left\{  1,2,...,m\right\}  ;\\\left\vert S\right\vert =i}}\prod\limits_{k\in
...
\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]  \right)  \left[  \left[
T\right]  \right]  $whenever $\varphi\in1+\mathbb{Z}\left[  \left[  t\right]
...
}U_{i}\text{, }\left(  \mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]
...
,...,X_{j}\right)  \text{ in }\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]
...
\[
X_{j}u^{j}=\operatorname*{Td}\nolimits_{1+ut,j}\left(  X_{1},X_{2}%
,...,X_{j}\right)  \text{ in }\mathbb{Z}\left[  U_{1},U_{2},...,U_{j}\right]
.
\]
...
$. Let $\mathfrak{Q}_{2}\in\mathbb{Z}\left[  \alpha_{1},\alpha_{2}%
...
Applying Theorem 4.1 \textbf{(a)} to $K=\mathbb{Z}$, $m=j$ and $P=X_{j}u^{j}$,
we conclude that there exists one and only one polynomial $Q\in\mathbb{Z}%
...
[c]{c}%
\text{if }\mathfrak{Q}_{1}\in\mathbb{Z}\left[  \alpha_{1},\alpha
_{2},...,\alpha_{j}\right]  \text{ and }\mathfrak{Q}_{2}\in\mathbb{Z}\left[
...
\begin{quote}
\textbf{Proposition 10.5.} Let $\left(  K,\left(  \lambda^{i}\right)
_{i\in\mathbb{N}}\right)  $ be a $\lambda$-ring. Let $\varphi\in
1+\mathbb{Z}\left[  \left[  t\right]  \right]  ^{+}$ be a power series with
...
$\varphi\in\mathbb{Z}\left[  \left[  t\right]  \right]  $ before $t^{1}$.
...
\begin{quote}
\textbf{Proposition 10.6.} Let $\varphi\in1+\mathbb{Z}\left[  \left[
...
$\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]  $ and its elements
$X_{i}=\sum\limits_{\substack{S\subseteq\left\{  1,2,...,m\right\}
...
element of $\mathbb{Z}\left[  \alpha_{1},\alpha_{2},...,\alpha_{0}\right]  $,
...
$\mathbb{Z}$.)} (by the definition of $\operatorname*{Coeff}\nolimits_{0}$)
and%
\begin{equation}
...
$\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]  $.

\textbf{(a)} Let $m=0$. Then, the polynomial rings $\mathbb{Z}\left[
U_{1},U_{2},...,U_{m}\right]  =\mathbb{Z}\left[  U_{1},U_{2},...,U_{0}\right]
$ and $\mathbb{Z}\left[  \alpha_{1},\alpha_{2},...,\alpha_{0}\right]  $ can be
canonically identified with the ring $\mathbb{Z}$ (because they are polynomial
...
But the equation (\ref{10.6.pf.1}) holds in the ring $\mathbb{Z}\left[
U_{1},U_{2},...,U_{m}\right]  =\mathbb{Z}\left[  U_{1},U_{2},...,U_{0}\right]
\cong\mathbb{Z}$. Hence, we have%
\[
...
\]
in the ring $\mathbb{Z}$. Hence, $\operatorname*{Td}\nolimits_{\varphi
,0}=\operatorname*{Td}\nolimits_{\varphi,0}\left(  X_{1},X_{2},...,X_{0}%
\right)  =1$. This proves Proposition 10.6 \textbf{(a)}.

\textbf{(b)} Let $m=1$. Then, $\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]
=\mathbb{Z}\left[  U_{1}\right]  $, and in this ring $\mathbb{Z}\left[
...
Now, let $\kappa$ be the $\mathbb{Z}$-algebra homomorphism $\mathbb{Z}\left[
\alpha_{1}\right]  \rightarrow\mathbb{Z}\left[  U_{1}\right]  $ which maps
...
$\mathbb{Z}$-algebra homomorphism and $\operatorname*{Td}\nolimits_{\varphi
...
(because $\mathbb{Z}$-algebra homomorphisms commute with polynomials). Now,%
\[
...
\]
(since $\kappa$ is a $\mathbb{Z}$-algebra homomorphism). Thus,
...
\begin{quote}
\textbf{Proposition 10.7.} Let $\left(  K,\left(  \lambda^{i}\right)
_{i\in\mathbb{N}}\right)  $ be a $\lambda$-ring. Let $\varphi\in
1+\mathbb{Z}\left[  \left[  t\right]  \right]  ^{+}$ and $\psi\in
1+\mathbb{Z}\left[  \left[  t\right]  \right]  ^{+}$ be two power series with
constant terms equal to $1$. For every $x\in K$, we have $\operatorname*{td}%
...
\begin{quote}
\textbf{Proposition 10.8.} Let $\varphi\in1+\mathbb{Z}\left[  \left[
t\right]  \right]  ^{+}$ and $\psi\in1+\mathbb{Z}\left[  \left[  t\right]
\right]  ^{+}$ be two power series with constant terms equal to $1$. Then,%
\[
...
\varphi\right)  }_{=1\text{ (since }\varphi\in1+\mathbb{Z}\left[  \left[
t\right]  \right]  ^{+}\text{)}}\cdot\underbrace{\left(  \text{constant term
of the power series }\psi\right)  }_{=1\text{ (since }\psi\in1+\mathbb{Z}%
\left[  \left[  t\right]  \right]  ^{+}\text{)}}\\
&  =1\cdot1=1,
\end{align*}
so that $\varphi\psi\in1+\mathbb{Z}\left[  \left[  t\right]  \right]  ^{+}$.
...
(\ref{Td1}) holds in the ring $\left(  \mathbb{Z}\left[  U_{1},U_{2}%
...
$\mathbb{Z}\left[  U_{1},U_{2},...,U_{m}\right]  =\mathbb{Z}\left[
U_{1},U_{2},...,U_{j}\right]  $.

Let $\mathfrak{Q}_{1}\in\mathbb{Z}\left[  \alpha_{1},\alpha_{2},...,\alpha
_{j}\right]  $ be the polynomial defined by $\mathfrak{Q}_{1}%
=\operatorname*{Td}\nolimits_{\varphi\psi,j}\left(  \alpha_{1},\alpha
_{2},...,\alpha_{j}\right)  $. Let $\mathfrak{Q}_{2}\in\mathbb{Z}\left[
...
Applying Theorem 4.1 \textbf{(a)} to $K=\mathbb{Z}$, $m=j$ and
$P=\operatorname*{Td}\nolimits_{\varphi\psi,j}\left(  X_{1},X_{2}%
,...,X_{j}\right)  $, we conclude that there exists one and only one
polynomial $Q\in\mathbb{Z}\left[  \alpha_{1},\alpha_{2},...,\alpha_{j}\right]
...
\mathbb{Z}\left[  \alpha_{1},\alpha_{2},...,\alpha_{j}\right]  $. Hence,
\begin{equation}
\left(
\begin{array}
[c]{c}%
...
\begin{quote}
\textbf{Proposition 10.9.} Let $\left(  K,\left(  \lambda^{i}\right)
_{i\in\mathbb{N}}\right)  $ be a $\lambda$-ring. Let $m\in\mathbb{N}$. For
every $i\in\left\{  1,2,...,m\right\}  $, let $\varphi_{i}\in1+\mathbb{Z}%
\left[  \left[  t\right]  \right]  ^{+}$ be a power series with constant term
equal to $1$. For every $x\in K$, we have%
\[
...
\right)  =1$. Thus, $\operatorname*{td}\nolimits_{1,T}=\operatorname*{td}%
\nolimits_{1+0t,T}\left(  x\right)  =\lambda_{0T}\left(  x\right)
=\operatorname*{ev}\nolimits_{0T}\left(  \lambda_{T}\left(  x\right)  \right)
=1$.}. The induction step is a straightforward application of Proposition
10.7. Thus Proposition 10.9 is proven.

As a consequence of Proposition 10.9, we have:

\textbf{Theorem 10.10.} Let $\left(  K,\left(  \lambda^{i}\right)
_{i\in\mathbb{N}}\right)  $ be a $\lambda$-ring. Let $\varphi\in
1+\mathbb{Z}\left[  t\right]  ^{+}$ be a polynomial with constant term equal
to $1$. Let us use the notations of Section 5. Let $\left(  \widetilde{K}%
,\left[  u_{1},u_{2},...,u_{n}\right]  \right)  \in K^{\operatorname*{int}}$
be such that $\varphi\left(  T\right)  =\Pi\left(  \widetilde{K},\left[
...
[...] SERIOUS\ PROBLEM! we don't have to increase $K$. we have to increase
$\mathbb{Z}$. but that won't be binomial, so $K$ loses its properties...

[...]

\begin{quote}
\textbf{Definition \& Theorem 10.X1.} Let $\varphi\in1+\mathbb{Z}\left[
\left[  t\right]  \right]  ^{+}$ be a power series with constant term equal to
$1$. There exists one and only one polynomial $\operatorname*{Td}_{\varphi
,j}\in\mathbb{Z}\left[  \alpha_{1},\alpha_{2},...,\alpha_{j}\right]  $ for
every $j\in\mathbb{N}$ such that%
\[
\prod\limits_{i=1}^{m}\varphi\left(  U_{i}T\right)  =\sum_{j\in\mathbb{N}%
}\operatorname*{Td}\nolimits_{\varphi,j}\left(  X_{1},X_{2},...,X_{j}\right)
T^{j}%
...
\textbf{Theorem 10.X2.} Let $\left(  K,\left(  \lambda^{i}\right)
_{i\in\mathbb{N}}\right)  $ be a $\lambda$-ring. Let $u_{1},$ $u_{2},$ $...,$
...
\textbf{Theorem 10.X3.} Let $\left(  K,\left(  \lambda^{i}\right)
_{i\in\mathbb{N}}\right)  $ be a $\lambda$-ring. Then, $\operatorname*{td}%
_{\varphi,T}\left(  K\right)  \subseteq\Lambda\left(  K\right)  $, and
