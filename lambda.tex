...
%TCIDATA{LastRevised=Monday, September 26, 2011 00:39:25}
...
\textit{Version 0.0.9, last revised 25 Sep 2011}
\end{center}
...
Theorem 5.5 \textbf{(e)}.} So let us assume that $u,v,w\in1+K\left[  T\right]
^{+}$. Then, there exist
...
,u_{2},...,u_{m}\right]  \right)  =\prod\limits_{i=1}^{m}\left(
...
\begin{equation}
\xymatrixcolsep{4pc}\xymatrix{ \Lambda\left(K\right) \ar@{^{(}->}[d] \ar[r]^{\widehat{\lambda}^i} & \Lambda\left(K\right) \ar@{^{(}->}[d] \\ \Lambda\left(K\left[S\right]\right) \ar[r]_{\widehat{\overline{\lambda}}^i} & \Lambda\left(K\left[S\right]\right) }\label{7.3.commdiag}%
\end{equation}
...
1-U_{i}T\right) \\
&  =-\sum_{j=1}^{m}\underbrace{\dfrac{U_{j}}{1-U_{j}T}\prod_{\substack{i\in
\left\{  1,2,...,m\right\}  ;\\i\neq j}}\left(  1-U_{i}T\right)  }%
_{=\prod\limits_{i\in\left\{  1,2,...,m\right\}  }\left(  1-U_{i}T\right)  }\\
...
\textit{Proof of Corollary 9.7.} Let $Q_{1}\in\mathbb{Z}\left[  \alpha
_{1},\alpha_{2},...,\alpha_{n}\right]  $ be the polynomial defined by
$Q_{1}=n\alpha_{n}$. Let $Q_{2}\in\mathbb{Z}\left[  \alpha_{1},\alpha
_{2},...,\alpha_{n}\right]  $ be the polynomial defined by $Q_{2}%
=\sum\limits_{j=1}^{n}\left(  -1\right)  ^{j-1}\alpha_{n-j}N_{j}\left(
\alpha_{1},\alpha_{2},...,\alpha_{j}\right)  $. We are going to prove that
$Q_{1}=Q_{2}$.
...
Theorem 4.1 \textbf{(b)} to $m=n$ and $P=nX_{n}$, we conclude that there
exists one and only one polynomial $Q\in K\left[  \alpha_{1},\alpha
_{2},...,\alpha_{n}\right]  $ such that $nX_{n}=Q\left(  X_{1},X_{2}%
,...,X_{n}\right)  $. In particular, there exists \textit{at most one} such
polynomial $Q\in K\left[  \alpha_{1},\alpha_{2},...,\alpha_{n}\right]  $.
Hence,
\begin{equation}
\left(
\begin{array}
[c]{c}%
\text{if }Q_{1}\in K\left[  \alpha_{1},\alpha_{2},...,\alpha_{n}\right]
\text{ and }Q_{2}\in K\left[  \alpha_{1},\alpha_{2},...,\alpha_{n}\right]
\text{ are two polynomials}\\
\text{such that }nX_{n}=Q_{1}\left(  X_{1},X_{2},...,X_{n}\right)  \text{ and
}nX_{n}=Q_{2}\left(  X_{1},X_{2},...,X_{n}\right)  \text{,}\\
\text{then }Q_{1}=Q_{2}%
\end{array}
\right)  . \label{9.7.pf1}%
\end{equation}
...
Clearly, $Q_{1}\left(  X_{1},X_{2},...,X_{n}\right)  =nX_{n}$ (since
$Q_{1}=n\alpha_{n}$). On the other hand, $Q_{2}=\sum\limits_{j=1}^{n}\left(
-1\right)  ^{j-1}\alpha_{n-j}N_{j}\left(  \alpha_{1},\alpha_{2},...,\alpha
_{j}\right)  $, so that%
\begin{align*}
Q_{2}\left(  X_{1},X_{2},...,X_{n}\right)   &  =\sum\limits_{j=1}^{n}\left(
-1\right)  ^{j-1}X_{n-j}N_{j}\left(  X_{1},X_{2},...,X_{j}\right) \\
&  =nX_{n}\ \ \ \ \ \ \ \ \ \ \left(  \text{by Theorem 9.6, applied to
}m=n\right)  .
\end{align*}
Hence, $Q_{1}=Q_{2}$ (due to (\ref{9.7.pf1})). Since $Q_{1}=n\alpha_{n}$ and
$Q_{2}=\sum\limits_{j=1}^{n}\left(  -1\right)  ^{j-1}\alpha_{n-j}N_{j}\left(
\alpha_{1},\alpha_{2},...,\alpha_{j}\right)  $, this rewrites as $n\alpha
_{n}=\sum\limits_{j=1}^{n}\left(  -1\right)  ^{j-1}\alpha_{n-j}N_{j}\left(
\alpha_{1},\alpha_{2},...,\alpha_{j}\right)  $. This proves Corollary 9.7.
...
.$ Consider this $\left(  \widetilde{K}_{u},\left[  u_{1},u_{2},...,u_{m}%
\right]  \right)  $. Then,
\begin{align*}
...
$ and some $\left(  \widetilde{K}_{v},\left[  v_{1},v_{2},...,v_{n}\right]
\right)  \in K^{\operatorname*{int}}$ such that $v=\Pi\left(  \widetilde{K}%
_{v},\left[  v_{1},v_{2},...,v_{n}\right]  \right)  $. Then, Theorem 5.3
\textbf{(c)} says that%
\[
