...
%TCIDATA{LastRevised=Tuesday, April 26, 2016 20:21:19}
...
\cite{Knut73}, albeit sometimes with a different proof. Part of the plan was
to add some results from the Fulton/Lang book \cite{FulLan85} with better
proofs, but this is not currently my short-term objective, given that I don't
understand much of \cite{FulLan85} to begin with. Most of the notes was
...
This theorem is more or less a rewriting of the famous \textit{Newton identities}.
