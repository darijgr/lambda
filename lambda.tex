...
%TCIDATA{LastRevised=Monday, October 10, 2011 12:26:24}
...
\textit{Version 0.0.11, last revised 9 Oct 2011}
\end{center}
...
\textit{Proof of Proposition 10.29.} Let $x\in K$. Then, $\lambda_{T}\left(
x\right)  =\sum\limits_{i\in\mathbb{N}}\lambda^{i}\left(  x\right)  T^{i}$, so
that%
\[
...
\textit{Proof of Proposition 10.32.} To obtain a proof of Proposition 10.16,
