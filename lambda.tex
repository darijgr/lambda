...
%TCIDATA{LastRevised=Thursday, September 15, 2011 12:21:43}
...
\textit{Version 0.0.6, last revised 15 Sep 2011}
\end{center}
...
and sections 10-... are more or less missing. Also, I am searching for a nice
proof (or a counterexample) to Theorem 9.2 in the case of arbitrary
(non-special) $\lambda$-rings.
...
the}\\\text{binomial formula}}}=\left(  1+T\right)  ^{x+y}=\sum_{k=0}%
^{x+y}\dbinom{x+y}{k}T^{k}%
\]
...
$...,$ $u_{m}$ be $1$-dimensional elements of $K$. Let $j\in\mathbb{N}%
\setminus\left\{  0\right\}  $. Then,%
\[
...
\textit{Remark:} If we would remove the word "special" in the definition of
$\psi^{j}$, then Theorem 9.4 would be true for all $\lambda$-rings $\left(
K,\left(  \lambda^{i}\right)  _{i\in\mathbb{N}}\right)  $ (not only for
special $\lambda$-rings $\left(  K,\left(  \lambda^{i}\right)  _{i\in
\mathbb{N}}\right)  $). In fact, the proof of Theorem 9.4 (and the 2nd step of
the proof of Theorem 9.2) work for \textit{any} $\lambda$-ring $\left(
K,\left(  \lambda^{i}\right)  _{i\in\mathbb{N}}\right)  $, not only for
special ones.
...
&  \in\underbrace{\left(  L-L\right)  L}_{\subseteq L-L}+\lambda^{i}\left(
\ell-\ell^{\prime}\right)  \subseteq\left(  L-L\right)  +\lambda^{i}\left(
\ell-\ell^{\prime}\right)  .
\end{align*}
...
\begin{align*}
p^{\left(  \varphi\left(  r\right)  -1\right)  in}\cdot u\left(
u-p^{i}\right)  ...\left(  u-\left(  n-1\right)  p^{i}\right)   &  =p^{\left(
\varphi\left(  r\right)  -1\right)  in}\cdot\prod\limits_{k=0}^{n-1}\left(
u-kp^{i}\right)  =\prod\limits_{k=0}^{n-1}\left(  p^{\left(  \varphi\left(
r\right)  -1\right)  i}\left(  u-kp^{i}\right)  \right) \\
...
p^{\left(  \varphi\left(  r\right)  -1\right)  i}u-k\right) \\
&  =\underbrace{n!}_{\equiv0\operatorname{mod}r}\dbinom{p^{\left(
\varphi\left(  r\right)  -1\right)  i}u}{n}\\
...
r\right)  -1\right)  in}\cdot n!}\cdot\dfrac{p^{\left(  \varphi\left(
...
know, as $\dbinom{x}{n}$) lies in $\left\{  1,p,p^{2},...\right\}
...
For every prime $q$, prove that $q$ appears in $x\cdot\left(  x-1\right)
\cdot...\cdot\left(  x-n+1\right)  $ at least as often as it appears in $n!$.
I would prefer a better proof, but I know of none.
