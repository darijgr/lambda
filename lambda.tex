...
%TCIDATA{LastRevised=Thursday, June 16, 2011 11:53:56}
...
\textit{Version 0.0.5, last revised 15 Jun 2011}
\end{center}
...
\[
\widehat{\lambda}^{j}\left(  u\widehat{+}v\right)  =\Pi\left(  \widetilde
{K}_{u,v},\left[  \prod\limits_{i\in I}w_{i}\ \mid\ I\in\mathcal{P}_{j}\left(
...
easier since we know what $\widehat{+}$, $\widehat{\cdot}$ and $\widehat
{\lambda}^{i}$ mean for elements of $1+K\left[  T\right]  ^{+}$ (this is what
Theorem 5.3 is for).
...
}1+eT=\Pi\left(  K^{\prime},\left[  e\right]  \right)  \right) \\
...
^{n-n}\left(  x\right)  \psi^{n}\left(  x\right)  \right)  =\underbrace
{\lambda^{n-n}\left(  x\right)  }_{=\lambda^{0}\left(  x\right)  =1}\psi
^{n}\left(  x\right)  =\psi^{n}\left(  x\right)  ,
\end{align*}
