...
%TCIDATA{LastRevised=Saturday, September 24, 2011 23:21:15}
...
.\ \ \ \ \footnote{One remark about the assumption that that for every
invertible element $u\in\mathbf{E}$, the inverse of $u$ must lie in
$\mathbf{E}$ as well:
\par
