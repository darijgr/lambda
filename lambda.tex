\documentclass
[numbers=enddot,12pt,final,onecolumn,notitlepage]{scrartcl}%
...
%TCIDATA{LastRevised=Tuesday, April 26, 2016 18:49:09}
...
\date{Version 0.0.17, last revised 9 Apr 2013}
\maketitle
\tableofcontents
...
\subsection{The equality $\widetilde{\psi}_{T}\left(  x\right) = -T\cdot\frac{d}{dT}\log\lambda_{-T}\left(  x\right)  $ for special $\lambda$-rings}
...
\subsection{The equality $\widetilde{\psi}_{T}\left(  x\right)  =-T\cdot\frac
