...
%TCIDATA{LastRevised=Tuesday, April 26, 2016 20:30:40}
...
inconsistent\footnote{Often, ``$\lambda$-ring'' in \cite{FulLan85} means
``$\lambda$-ring with a positive structure'' (such $\lambda$-rings are
...
``mapping'' and not ``group homomorphism'' or ``ring homomorphism''.} for
every $i\in\mathbb{N}$ such that $\lambda^{0}\left(  x\right)  =1$ and
$\lambda^{1}\left(  x\right)  =x$ for every $x\in K$. Assume that%
\begin{equation}
...
homomorphism'' or ``ring homomorphism''.} for every $i\in\mathbb{N}$ such that
...
\begin{proof}[Proof of Theorem 2.1.] \textbf{(a)} Every $x\in K$ and every $y\in K$
satisfy%
\begin{align*}
...
\begin{proof}[Proof of Theorem 3.1.] Trivially, $\lambda^{0}\left(  x\right)  =1$
...
\begin{proof}[Proof of Theorem 3.2.] Obviously, $\lambda^{0}\left(  x\right)  =1$
...
\begin{proof}[Proof of Theorem 3.3.] \textbf{(a)} Define a map $\overline{\lambda
...
\begin{proof}[Proof of Theorem 4.2 (\textbf{very} roughly sketched).] \textbf{(a)}
...
\begin{proof}[Proof of Theorem 4.3.] \textbf{(a)} \textit{1st Step:} Fix
...
\begin{proof}[Proof of Theorem 4.4.] \textbf{(a)} \textit{1st Step:} Fix
...
\begin{proof}[Proof of Theorem 5.2.] Write the polynomial $p$ in the form
...
\begin{proof}[Proof of Theorem 5.3.] The assumption that $u=\Pi\left(
...
\begin{proof}[Proof of Corollary 5.4.] Part \textbf{(a)} follows by induction from
...
\begin{proof}[Proof of Theorem 5.3' \textbf{(d)}.] Since $L$ is a finite set used
...
\begin{proof}[Proof of Theorem 5.5.] \textbf{(a)} and \textbf{(e)} are done in any
...
\begin{proof}[Proof of Theorem 5.1.] \textbf{(a)} We have to prove the ring axioms
...
\begin{proof}[Proof of Theorem 5.6.] The map $\lambda_{T}$ is well-defined (i. e.
...
\begin{proof}[Proof of Theorem 5.7.] \textbf{(a)} Obvious from Theorem 5.5
...
\begin{proof}[Proof of Theorem 6.1.] According to the preceding definition, $\left(
...
\begin{proof}[Proof of Theorem 6.2.] According to Theorem 6.1, we only have to prove
that%
\begin{align}
...
\begin{proof}[Proof of Theorem 7.1.] According to Theorem 6.1, we just have to
...
\begin{proof}[Proof of Theorem 7.2.] This follows from our proof of Theorem 7.1 in
...
\begin{proof}[Proof of Theorem 7.3.] As in the proof of Theorem 3.3, we can define a
...
\begin{proof}[Proof of Theorem 8.2.] This is clear, since $\left(
...
\begin{proof}[Proof of Theorem 8.1.] Since $\left(  K,\left(  \lambda^{i}\right)
...
\begin{proof}[Proof of Theorem 8.3.] \textbf{(a)} In fact,%
\[
\lambda_{T}\left(  x\right)  =\sum\limits_{i\in\mathbb{N}}\lambda^{i}\left(
...
\begin{proof}[Proof of Theorem 8.4.] We have to prove that $m=m^{\prime}$. In other
...
\begin{proof}[Proof of Theorem 8.5.] We have%
\begin{align*}
...
\begin{proof}[Proof of Theorem 9.1.] \textbf{(a)} This proof is going to be very
...
\begin{proof}[Proof of Theorem 9.2.] \textit{1st step:} For any fixed special
$\lambda$-ring $\left(  K,\left(  \lambda^{i}\right)  _{i\in\mathbb{N}%
...
\begin{proof}[Proof of Theorem 9.4.] Let $x=u_{1}+u_{2}+...+u_{m}$. Just as in the
...
\begin{proof}[Proof of Theorem 9.3.] \textbf{(a)} is trivial (for instance, by
Theorem 9.2 \textbf{(a)}).
...
\begin{proof}[Proof of Theorem 9.6.] In the power series ring $\left(
...
\begin{proof}[Proof of Corollary 9.7.] We WLOG assume that $n>0$ (since for $n=0$,
...
\begin{proof}[Proof of Theorem 9.5.] \textit{1st step:} For any fixed $\lambda$-ring
...
\begin{proof}[Proof of Lemma 10.2.] By the definition of $\operatorname*{Todd}%
...
\begin{proof}[Proof of Theorem 10.1.] This proof is going to be very similar to the
...
\begin{proof}[Proof of Proposition 10.4.] Let $m\in\mathbb{N}$. Consider the ring
...
\begin{proof}[Proof of Proposition 10.6.] Let $m\in\mathbb{N}$. Consider the ring
...
\begin{proof}[Proof of Proposition 10.5.] Let $x\in K$.
...
\begin{proof}[Proof of Proposition 10.3.] Let $x\in K$. Applying (\ref{ToddDef}) to
...
\begin{proof}[Proof of Proposition 10.8.] \textit{1st Step:} We have $\varphi\psi
...
\begin{proof}[Proof of Proposition 10.7.] \textit{1st Step:} For every
...
\begin{proof}[Proof of Proposition 10.9.] This can be proven by induction over $m$.
...
\begin{proof}[Proof of Proposition 10.11.] Let $x\in K$. Then, $\lambda_{T}\left(
...
\begin{proof}[Proof of Proposition 10.12.] The coefficient of the power series $p$
...
\begin{proof}[Proof of Proposition 10.13.] \textbf{(a)} We have%
\begin{align*}
...
\begin{proof}[Proof of Proposition 10.14.] For every $j\in\mathbb{N}$, we will
...
\begin{proof}[Proof of Proposition 10.15.] This can be proven by induction over $m$.
...
\begin{proof}[Proof of Theorem 10.18.] The parts \textbf{(a)} and \textbf{(c)} of
...
\begin{proof}[Proof of Proposition 10.19.] Let $f$ denote the map
\[
1+K\left[  \left[  t\right]  \right]  ^{+}\rightarrow K\left[  \left[
T\right]  \right]  ,\ \ \ \ \ \ \ \ \ \ \varphi\mapsto\mathfrak{Todd}%
_{\varphi}\left(  p\right)  .
...
\begin{proof}[Proof of Lemma 10.17.] Fix $p\in1+K\left[  \left[  T\right]  \right]
...
\begin{proof}[Proof of Proposition 10.21.] Let $\varphi\in1+\mathbf{Z}\left[
\left[  t\right]  \right]  ^{+}$.
...
\begin{proof}[Proof of Corollary 10.22.] Clearly, the ring homomorphism
$\rho:\mathbf{Z}\rightarrow\mathbf{Z}^{\prime}$ canonically induces a ring
homomorphism $\rho\left[  \alpha_{1},\alpha_{2},...,\alpha_{j}\right]
:\mathbf{Z}\left[  \alpha_{1},\alpha_{2},...,\alpha_{j}\right]  \rightarrow
...
\begin{proof}[Proof of Theorem 10.16.] Since $K$ is a $\mathbf{Z}$-algebra, there is
...
\begin{proof}[Proof of Theorem 10.10.] Theorem 2.1 \textbf{(a)} yields $\lambda
...
\begin{proof}[Proof of Corollary 10.23.] Every $x\in K$ satisfies
...
\begin{proof}[Proof of Proposition 10.25.] Let $m=1$. Consider the ring
$\mathbf{Z}\left[  U_{1},U_{2},...,U_{m}\right]  $ and its elements
$X_{i}=\sum\limits_{\substack{S\subseteq\left\{  1,2,...,m\right\}
;\\\left\vert S\right\vert =i}}\prod\limits_{k\in S}U_{k}$ as in the
definition of $\operatorname*{Td}\nolimits_{\varphi,j}$.
...
\begin{proof}[Proof of Proposition 10.26.] For every $j\in\mathbb{N}$, let
...
\begin{proof}[Proof of Proposition 10.24.] Proposition 10.11 (applied to $x=u$)
...
\begin{proof}[Proof of Theorem 10.27.] By Corollary 10.23, we know that
...
\begin{proof}[Proof of Theorem 10.28.] \textit{1st Step:} The equality
...
\begin{proof}[Proof of Theorem X.1.] \textbf{(b)} \textit{1st Step:} We have
...
\begin{proof}[Proof of Theorem 2.3.] Let
...
by recalling the fact (\cite[Proposition I.7.3]{Harts77}) that the subset%
\[
...
\begin{proof}[Proof of Lemma 5.1.S.1.] Let $n=\deg P$. Let $K^{\prime}$ be the
...
\begin{proof}[Proof of Lemma 5.1.S.2.] \textbf{(a)} Lemma 5.1.S.2 \textbf{(a)} is a
...
\begin{proof}[Proof of Lemma 5.2.S.1.] Since $TS-1\mid P$ in $L\left[  T,S\right]
...
\begin{proof}[Proof of Lemma 5.4.S.1.] Assume that $\sum\limits_{i=0}^{\ell}%
...
\begin{proof}[Proof of Lemma 5.4.S.2.] Since $\alpha$ is $n$-integral over $K$,
...
a block-triangular matrix\footnote{Here, when I say ``block-triangular
matrix'', I always mean a block-triangular matrix whose diagonal blocks are
square matrices.}, with the left upper block (of size $\left(  k-1\right)
...
\begin{proof}[Proof of Proposition 10.29.] Let
...
\begin{proof}[Proof of Proposition 10.30.] Let $\iota:K\rightarrow K\otimes
...
\begin{proof}[Proof of Proposition 10.31.] Let $x\in K$.
...
\begin{proof}[Proof of Proposition 10.32.] To obtain a proof of Proposition 10.32,
...
\begin{proof}[Proof of Proposition 10.33.] This can be proven by induction over $m$.
The induction base (the case $m=0$) requires showing that $\operatorname*{td}%
...
\begin{proof}[Proof of Theorem 10.34.] Theorem 2.1 \textbf{(a)} yields $\lambda
_{T}\left(  x\right)  \cdot\lambda_{T}\left(  y\right)  =\lambda_{T}\left(
x+y\right)  $ (since $\left(  K,\left(  \lambda^{i}\right)  _{i\in\mathbb{N}%
}\right)  $ is a $\lambda$-ring).
...
\begin{proof}[Proof of Corollary 10.35.] Every $x\in K$ satisfies
$\operatorname*{td}_{\varphi,T,\mathbf{Z}^{\prime}}\left(  x\right)
...
\begin{proof}[Proof of Proposition 10.36.] Let $\iota:K\rightarrow K\otimes
_{\mathbf{Z}}\mathbf{Z}^{\prime}$ be the canonical map (mapping every $\xi\in
...
\begin{proof}[Proof of Theorem 10.37.] Theorem 10.37 can be proven with the help of
