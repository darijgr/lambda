...
%TCIDATA{LastRevised=Friday, September 16, 2011 00:50:00}
...
\textit{Version 0.0.7, last revised 16 Sep 2011}
\end{center}
...
2}\underbrace{\lambda^{i}\left(  u\right)  }_{\substack{=0,\text{
since}\\i>1=\varepsilon\left(  u\right)  \\\text{and }u\in\mathbf{L}%
\subseteq\mathbf{E}}}T^{i}=1+uT.
\]
