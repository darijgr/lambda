...
%TCIDATA{LastRevised=Monday, February 25, 2013 23:33:13}
...
\date{Version 0.0.17, last revised 29 Dec 2012}
\maketitle
\tableofcontents
...
Theorem 2.1 \textbf{(d)}), so that $\lambda^{i}\left(  t\right)
\in\operatorname*{Ker}f$.
