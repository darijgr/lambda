...
%TCIDATA{LastRevised=Monday, February 28, 2011 23:37:20}
...
\textit{Version 0.0.5, last revised 28 Feb 2011}
\end{center}
...
=\prod\limits_{i=1}^{n}\left(  1+\mu u_{i}T\right)  =\Pi\left(  \widetilde{K}%
_{u},\left[  \mu u_{1},\mu u_{2},...,\mu u_{m}\right]  \right)  $, and Theorem
5.7 \textbf{(b)} is proven.
...
^{k}\left(  u\right)  ,\widehat{\lambda}^{1}\left(  v\right)
,\widehat{\lambda}^{2}\left(  v\right)  ,...,\widehat{\lambda}^{k}\left(
v\right)  \right)  .
\]
But%
\begin{align*}
...
\overline{\lambda}_{T}\left(  aS^{\alpha}\right)  \right)  =\widehat{\overline
{\lambda}}^{i}\left(  \operatorname*{ev}\nolimits_{S^{\alpha}T}\left(
\lambda_{T}\left(  a\right)  \right)  \right)  \ \ \ \ \ \ \ \ \ \ \left(
\text{since }\overline{\lambda}_{T}\left(  aS^{\alpha}\right)  =\lambda
_{S^{\alpha}T}\left(  a\right)  =\operatorname*{ev}\nolimits_{S^{\alpha}%
...
L}_{\subseteq L-L}+\lambda^{i}\left(  \ell-\ell^{\prime}\right)
\subseteq\left(  L-L\right)  +\lambda^{i}\left(  \ell-\ell^{\prime}\right)  .
\end{align*}
...
\varphi\left(  r\right)  -1\right)  i}u}{n}\ \ \ \ \ \ \ \ \ \ \left(
\text{since }\dfrac{\prod\limits_{k=0}^{n-1}\left(  p^{\left(  \varphi\left(
r\right)  -1\right)  i}u-k\right)  }{n!}=\dbinom{p^{\left(  \varphi\left(
r\right)  -1\right)  i}u}{n}\right) \\
...
\right)  ^{n}=\left(  1+T\right)  ^{n}\ \ \ \ \ \ \ \ \ \ \left(  \text{since
}\lambda_{T}\left(  1\right)  =1+T\text{, because the }\lambda\text{-ring
}K\text{ is special}\right) \\
...
\end{array}
\right.  \cdot\psi^{i}\left(  x\right)  \ \ \ \ \ \ \ \ \ \ \left(  \text{here
we substituted }i\text{ for }k-1\text{ in the sum}\right) \\
...
_{i=1}^{n-1}\left(  -1\right)  ^{i-1}\lambda^{n-i}\left(  x\right)  \psi
^{i}\left(  x\right)  \right)  \ \ \ \ \ \ \ \ \ \ \left(  \text{by part
\textbf{(a)}}\right) \\
